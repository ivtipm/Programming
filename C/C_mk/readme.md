...
3. Ввод и вывод. `printf`, `puts`, `scanf`.  
    - [Локаль и кодировка символов](https://github.com/ivtipm/Programming/blob/master/C/locale_encoding.md)
...
1. Округление (round, floor, ceil, trunk); округление до k знаков. Переполнение чисел.
...
1. Понятие структурированных данных. 
    ...
    - Функции-инициализаторы. Функции для вывода на экран. Функции дя сравнения. sprintf. 
...
## 9. *Адреса, указатели, ссылки, динамические данные и массивы*

...
2. Понятие среды разработки (IDE) и её основные компоненты. Панели. Запуск и сборка. Режимы запуска и сборки.
    ...
    - [Компиляция из командной строки](studbook/100_compile.md)
        ...
        1. - [Компиляция, запуск и отладка в Zed](studbook/110_compile_run_debug_in_zed.md)
...
1. Ввод и вывод. `printf`, `puts`, `scanf`.
    - [Локаль и кодировка символов](studbook/120_locale_encoding.md)
...
1. [Таблица типов данных](studbook/200_data_types_table.md)
...
1. Строки и кодировки: ASCII, Unicode, UTF-8, работа с русскими буквами.
    1. [Строки и кодировки](studbook/510_strings_encoding.md)
...
1. Процедурное программирование.
    ...
    - Передача аргументов по ссылке (указателю) и по значению. [Подробнее](studbook/600_by_reference.md). Const указатели.
...
1. *Компиляция .c файлов в статическую библиотеку.

[Модульное программирование в C](studbook/700_modules.md) Использование статической библиотеки в программе.*




## 8. Адреса, указатели, ссылки, динамические данные и массивы
...
1. Понятие динамических данных.
    ...
    - undefined behavior (на примере двойного освобождения)
        - [Управление памятью: стек, куча, malloc/free](studbook/800_memory.md)
...
[Препроцессор](studbook/900_preprocessing.md)
...
## Ссылки
- [Примеры программ на C](studbook/examples.md)
- [100 — Компиляция из командной строки](studbook/100_compile.md)
- [110 — Компиляция, запуск и отладка в Zed](studbook/110_compile_run_debug_in_zed.md)
- [120 — Локаль и кодировка символов](studbook/120_locale_encoding.md)
- [510 — Строки и кодировки: ASCII, Unicode, UTF-8](studbook/510_strings_encoding.md)
- [200 — Таблица типов данных](studbook/200_data_types_table.md)
- [700 — Модульное программирование](studbook/700_modules.md)
- [800 — Управление памятью](studbook/800_memory.md)
- [900 — Препроцессор](studbook/900_preprocessing.md)
